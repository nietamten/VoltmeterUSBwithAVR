/*
 * File:   usb_hid_sensors.h
 */

/*
 * Data from http://www.usb.org/developers/hidpage/HUTRR39b.pdf as of 2014-04-29
 * Review Request 39: HID Usage Table Sensor Page
 * Pages 71-78
 *
 * This data is believed available to use because:
 * 1. Oracle America, Inc. v. Google, Inc. 2012 held that header files can be
 *    copied.
 * 2. It was provied in a public document in a manner intended for this use.
 */

#ifndef USB_HID_SENSORS_H
#define	USB_HID_SENSORS_H
...
/* HID descriptor-building helpers */
...
/* The following ORs the MODifier */
